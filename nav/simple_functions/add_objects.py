...
rigid_obj_mgr = env.get_rigid_object_manager()
obj_templates_mgr = env.get_object_template_manager()
obj_id = obj_templates_mgr.load_object_configs(
    str("/home/yuanzhao/PycharmProjects/navigation/data/object_assets/apple")
)[0]
obj = rigid_obj_mgr.add_object_by_template_id(obj_id)
obj.translation = [-1.301088  ,  0.3, -5.663709  ]
obj.rotation = _magnum.Quaternion(_magnum.Vector3(0.00233217, 0.0, -0.00095109),1)
